...
import classes from "./pFilter.module.css";

export const PFilter = ({ minDataValue,
  maxDataValue,
  onClose,
  onSelection,
  onApply,
      ...
      >
        <div className={classes.box__content}>
          <div className={classes.box__content__head}>
            <h1 className={classes.box__content__head__title}>P4%</h1>
            <button
        ...
        <div className={classes.box__btn}>
          ...
          <button className={classes.box__btn__apply} onClick={handleApply}>Apply</button>
        </div>
      </motion.div>
    </div>
  );
